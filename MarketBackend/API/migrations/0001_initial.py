# Generated by Django 3.0.5 on 2020-09-04 09:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('engineType', models.CharField(choices=[('DIZEL', 'D'), ('BENZIN', 'B'), ('BENZIN+LPG', 'B+LPG')], default='BENZIN', max_length=10)),
                ('engineCapacity', models.IntegerField()),
                ('shifterType', models.CharField(choices=[('AUTOMATSKI', 'A'), ('RUCNI', 'M')], default='RUCNI', max_length=10)),
